...
<!-- Data Table -->
          <div class="box">
            ...
            <div class="row">
               <form class="form-horizontal" method="post" action="add_post_process.php" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="" class="col-sm-2 control-label">Post Title</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="post_title" placeholder="Enter Your Post Title Here">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="post_content" rows="20" cols="80"></textarea>
                    </div>
                  </div>
                </div>
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="file" class="form-control" name="post_thumbnail" placeholder="Post Thumbnail">
                  </div>
                </div>
                <div class="form-group">
                 <div class="col-sm-5"></div>
                  ...
                  <div class="col-sm-2">
                   ...
                   <button type="submit" class="btn btn-info pull-right">Add Post</button>
                  </div> 
                </div>
