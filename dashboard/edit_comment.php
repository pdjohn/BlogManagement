...
if(isset($_SESSION['isLoggedIn']) && $_SESSION['isLoggedIn'] ==='yes'):
  ...
  <?php if(isset($_GET['comment_id']) && $_GET['comment_id']!='')
   ...
   ?>
  <?php $sql = "SELECT * FROM comments WHERE comment_id=$comment_id";
          ...
          <div class="box">
            ...
            <div class="box-body">
              <?php if($user_type === '1'): ?>
                ...
                <div class="row">
                 <form class="form-horizontal" method="post" action="edit_comment_process.php" enctype="multipart/form-data">
                  <div class="box-body">
                    <input type="hidden" class="form-control" name="user_id" value="<?php echo $user_id ?>">
                    <input type="hidden" name="comment_ip" value="<?php echo $_SERVER['REMOTE_ADDR'];?>">
