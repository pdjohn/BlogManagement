        ...
        <div class="box">
          ...
          <div class="box-body">
            <?php if($user_type === '1'): ?>
              ...
              <div class="row">
               <form class="form-horizontal" method="post" action="site_adds_setting_process.php">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea name="js_code" id="" cols="30" rows="10" placeholder="JS Code"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                     <input type="radio" name="show"  value="image"> Image
                     <input type="radio" name="show" value='code'> Code
                   </div> 
                 </div>
                 <div class="form-group">
                   ...
                   <div class="col-sm-2">
                    ...
                    <button type="submit" class="btn btn-info pull-right">Save Ads</button>
                  </div> 
                </div>
