<?php include_once 'inc/functions.php' ;
    // include_once 'inc/post_model.php';

if(isset($_GET['post_id']) && $_GET['post_id']!=''){
    $singlepost= single_post($_GET['post_id']);
                ...
                <?php while($post = $singlepost->fetch_assoc()): ?>
                    <div class="blog-detail-post">
                        <div class="blog-details-post-img">
                            <img src="<?php echo $media_path.'/'.$post['post_thumbnail']; ?>" class="img-responsive">
                        </div>
                        ...
                        <div class="blog-details-author-tag">
                            <ul class="list-inline">
                                <li><span><i class="fa fa-user" aria-hidden="true"></i></span> <?php echo blog_author($post['user_id']);?></li>
